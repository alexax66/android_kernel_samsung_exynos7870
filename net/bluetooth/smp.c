...
static int smp_c1(struct smp_chan *smp, const u8 k[16], const u8 r[16],
		  const u8 preq[7], const u8 pres[7], u8 _iat,
...
static int smp_s1(struct smp_chan *smp, const u8 k[16], const u8 r1[16],
		  const u8 r2[16], const u8 _r[16])
{
	struct hci_dev *hdev = smp->conn->hcon->hdev;
	int err;
